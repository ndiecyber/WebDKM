<template>
  <div class="space-y-6 sm:space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      ...
      >
        <div class="relative aspect-video overflow-hidden shrink-0 border-b border-gray-200 dark:border-white/5">
          ...
          <div class="absolute inset-0 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <button @click="openModal(item)" class="w-9 h-9 rounded-lg bg-white/90 dark:bg-gray-800/90 hover:bg-white dark:hover:bg-gray-700 text-gray-700 dark:text-white flex items-center justify-center ring-1 ring-gray-200 dark:ring-white/20 transition-colors shadow-sm" title="Edit">
              <Edit2 class="w-4 h-4" />
            </button>
            <button @click="deleteItem(item.id)" class="w-9 h-9 rounded-lg bg-red-500/90 hover:bg-red-500 text-white flex items-center justify-center ring-1 ring-red-500/50 dark:ring-white/20 transition-colors shadow-sm" title="Hapus">
            ...
            <div class="space-y-1">
              ...
              >
                <div class="text-center">
                  <div class="mx-auto w-12 h-12 rounded-full bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-transparent flex items-center justify-center mb-4">
