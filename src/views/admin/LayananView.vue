<template>
  <div class="space-y-6 sm:space-y-8">
            ...
            <tr v-for="item in adminStore.layanan" :key="item.id" class="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors group">
              <td class="py-4 px-4 sm:px-6">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 ring-1 ring-gray-200 dark:ring-white/10 flex items-center justify-center shrink-0 text-gray-600 dark:text-gray-400">
    ...
    <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div class="relative bg-white dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-white/10 rounded-xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200">
        ...
        <div class="p-6 overflow-y-auto">
          <form @submit.prevent="saveItem" class="space-y-6">
            ...
            <div class="border-t border-gray-200 dark:border-white/5 pt-6 mt-6">
              ...
              <div class="space-y-4">
                <div class="space-y-1">
                  ...
                  <textarea 
                    ...
                    class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-2 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:ring-2 focus:ring-secondary transition-all resize-none text-sm outline-none"
                  ></textarea>
                </div>
