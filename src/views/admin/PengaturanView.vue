  ...
  <form @submit.prevent="saveSettings" class="space-y-6 sm:space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <button 
        type="submit"
        :disabled="isSaving"
        class="bg-secondary hover:bg-yellow-500 text-white dark:text-gray-950 font-medium px-4 py-2 rounded-lg transition-colors shadow-sm text-sm flex items-center gap-2 justify-center shrink-0 disabled:opacity-70 disabled:cursor-not-allowed"
      >
        ...
        <div class="p-6 sm:p-8 space-y-6">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="space-y-1.5">
              ...
              <input 
                ...
                type="text" 
                class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-transparent dark:ring-1 dark:ring-white/10 rounded-lg px-3 py-2 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:ring-2 focus:ring-secondary transition-all text-sm shadow-sm"
              />
            </div>
            <div class="space-y-1.5">
          ...
          <div class="space-y-1.5">
            ...
            <textarea 
              ...
              rows="3"
              class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-transparent dark:ring-1 dark:ring-white/10 rounded-lg px-3 py-2 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:ring-2 focus:ring-secondary transition-all resize-none text-sm shadow-sm"
            ></textarea>
            <p class="text-xs text-gray-500">Teks ini akan muncul tepat di bawah slogan utama di halaman pertama.</p>
          </div>

          <div class="space-y-1.5 border-t border-gray-200 dark:border-white/5 pt-6 mt-6">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Sejarah Singkat (Tentang Kami)</label>
            
            <!-- Rich Text Editor UI -->
            <div class="border border-gray-200 dark:border-transparent dark:ring-1 dark:ring-white/10 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-secondary transition-all bg-gray-50 dark:bg-white/5">
              <!-- Toolbar -->
              <div class="flex items-center gap-1 p-2 border-b border-gray-200 dark:border-white/10 bg-gray-100 dark:bg-gray-900/50 flex-wrap">
      ...
      <section class="bg-white dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-white/10 rounded-xl shadow-sm">
        ...
        <div class="p-6 sm:p-8 space-y-6">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="space-y-1.5">
              ...
              <div class="relative">
                ...
                <input 
                  ...
                  type="url" 
                  class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-transparent dark:ring-1 dark:ring-white/10 rounded-lg pl-9 pr-3 py-2 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:ring-2 focus:ring-secondary transition-all text-sm shadow-sm"
                />
              </div>
            </div>
            ...
            <div class="sm:col-span-2 space-y-1.5 border-t border-gray-200 dark:border-white/5 pt-6 mt-6">
