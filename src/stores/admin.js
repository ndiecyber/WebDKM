...
export const useAdminStore = defineStore('admin', {
  state: () => ({
    ...
    layanan: parseSafe('admin_layanan_v10') || [
  ...
  actions: {
    ...
    saveKegiatan() {
      setStorage('admin_kegiatan_v11', JSON.stringify(this.kegiatan))
    },
    updateFinance(data) {
    ...
    saveLayanan() {
      setStorage('admin_layanan_v10', JSON.stringify(this.layanan))
    },
    saveGeneralSettings() {
